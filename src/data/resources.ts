...
export const newsItems: NewsItem[] = [
  {
    id: "glasswing",
    title: "Anthropic Launches Project Glasswing — AI-Powered Cybersecurity",
    summary: "A new Anthropic initiative to secure critical software and give defenders a durable advantage in the coming AI-driven era of cybersecurity.",
    source: "Anthropic",
    provider: "Anthropic",
    ...
    category: "industry",
    official: true,
    tags: ["anthropic", "security", "enterprise"],
  },
  {
    id: "gemini-3d-charts",
    title: "Gemini Can Now Generate 3D Models and Interactive Charts",
    summary: "The Gemini app can transform questions and complex topics into custom interactive visualizations, simulations, and 3D models.",
    source: "Google Blog",
    provider: "Google",
    ...
    official: true,
    tags: ["gemini", "visualization", "3d", "feature"],
  },
  {
    id: "openai-pro-100",
    title: "OpenAI Introduces $100/Month Pro Tier — Includes Codex Access",
    summary: "OpenAI updated ChatGPT Pro and Plus subscriptions to better support Codex, their new AI coding agent. Pro bumps to $100/month.",
    ...
    category: "product-update",
    official: true,
    tags: ["openai", "pricing", "codex", "chatgpt"],
  },
];

      ...
      <div className="flex-1 flex items-center justify-center px-6">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-black text-gray-900 mb-1">Member Access</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <input
              ...
              className="w-full px-4 py-3.5 rounded-2xl border border-gray-200 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-orange-400 text-sm"
              autoFocus
            />
            {error && (
            ...
            <button
              ...
              className="w-full bg-orange-500 hover:bg-orange-600 disabled:opacity-40 text-white font-bold py-3.5 rounded-2xl transition-colors text-sm"
            >
          ...
          <p className="text-center text-xs text-gray-400 mt-6">
            Not a member?{" "}
            <a href="https://calendly.com/1stbaseai/30min" className="text-orange-500 hover:underline">
